...
const PersonalizeProfile = () => {
  ...
  return (
    <section className="bg-primary min-h-80 flex flex-col items-center p-[31px]">
      <h1 className="text-textSecondary text-center text-[20px] md:text-[54px] mt-[12px] md:mt-[135px] font-bold">
        5 minute set-up process
      </h1>
      <p className="hidden md:block text-[24px] text-textPrimary text-center mt-[24px]">
        Just take <strong>5 minutes</strong> to fill in some info, choose a
        killer template, and <br /> bam! Your personalized portfolio website is
        ready.
      </p>

      <CardLayout
        className="rounded-[30px] px-[18px] py-[14px] md:p-[50px] mt-[20px] md:mt-[68px]
      ...
      >
        <div className="hidden md:flex gap-[8px] items-center">
          <Image src="/stars.svg" alt="stars" width={25} height={25} />
