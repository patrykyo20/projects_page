...
const Message = ({ params }: { params: { id: number } }) => {
  ...
  return (
    <>
      {message ? (
        <h1 className="text-textSecondary text-center text-[40px] md:text-[54px] mt-[12px] md:mt-[12px] font-bold">
          {message?.title}
        </h1>
      ) : (
      ...
      <section className="mt-20 grid justify-center w-full pb-24">
        <article className="lg:max-w-[1500px] gap-20 p-3 md:p-4">
          <div className="flex flex-col justify-between">
            ...
            <Link
              className="flex mt-5 gap-5 items-end"
            ...
            >
              <Image
                ...
                height={75}
              />
              <p className="text-headline text-[36px] font-semibold">
                {message?.author}
              </p>
            </Link>
