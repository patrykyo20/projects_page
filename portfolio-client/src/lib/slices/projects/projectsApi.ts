...
export const projectApi = createApi({
  ...
  endpoints: (builder) => ({
    getAllProjects: builder.query<
      Project[],
      { page: number; pagePerSize: number; order: string; sort: string }
    >({
    ...
    getProject: builder.query<Project, number | undefined>({
      query: (id) => ({
        url: `/${id}`,
      }),
    }),
    ...
    addLikes: builder.mutation<
      Project,
      { id: number | undefined; data: Project | undefined }
    >({
      query: ({ id, data }) => ({
        url: `/${id}`,
        method: "PATCH",
    ...
    addVisits: builder.mutation<
      Project,
      { id: number | undefined; data: Project }
    >({
      query: ({ id, data }) => ({
        url: `/${id}`,
        method: "PATCH",
