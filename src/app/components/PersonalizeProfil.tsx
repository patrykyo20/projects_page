...
const PersonalizeProfile = () => {
  ...
  return (
    <section className="bg-primary min-h-80 flex flex-col items-center p-[31px]">
      ...
      <div className="border-2 border-t-[0.5px] border-r-4 border-b-4 border-l-4 border-headline
        rounded-[30px] px-[18px] py-[14px] md:p-[50px] mt-[20px] md:mt-[68px] grid grid-cols-1
        md:grid-cols-2 justify-center md:items-center max-w-[1520px]">
